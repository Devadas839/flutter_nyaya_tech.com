...
class _FilesWidgetState extends State<FilesWidget> {
  ...
  Future<void> fetchdata() async {
    await _model.fetchDocx();
  }

  FilePickerResult? result;

  Future<List<XFile>?> _openGallery() async {
                          ...
                          onTap: () async {
                            ...
                            if (result != null) {
                              List<XFile> files = result!.paths
                                  .map((path) => XFile(path!))
                                  .toList();
                              var maximages = min(files.length, 5);
                              setState(() {
