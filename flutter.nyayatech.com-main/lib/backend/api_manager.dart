...
class ApiManager {
  ...
  static void clearCache(String callName) {
    final keysToRemove =
        _apiCache.keys.where((k) => k.callName == callName).toList();
  ...
  static Future<ApiCallResponse> requestWithBody(
    ...
    assert(
      {ApiCallType.POST, ApiCallType.PUT, ApiCallType.PATCH, ApiCallType.DELETE}
          .contains(type),
    ...
    final requestFn = {
      ...
      ApiCallType.DELETE: http.delete,
    }[type]!;
  ...
  static String? getMimeType(String? filename) {
    return _getMediaType(filename)?.mimeType;
  }
  ...
  static dynamic createBody(
    ...
    params = params != null ? Map.from(params) : {};
